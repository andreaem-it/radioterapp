...
//  RadioterapApp
//
//  Created by Andrea Emili on 01/09/2018.
//  Copyright © 2018 andreaem. All rights reserved.
//

import UIKit

protocol MonthViewDelegate : class {
    func didChangedMonth(monthIndex: Int, year: Int)
}

class MonthView : UIView {
    var monthsArr = ["Gennaio","Febbraio","Marzo","Aprile","Maggio","Giugno","Luglio","Agosto","Settembre","Ottobre","Novembre","Dicembre"]
    ...
    @objc func btnLeftRightAction(sender: UIButton) {
        ...
        delegate?.didChangedMonth(monthIndex: currentMonthIndex, year: currentYear)
    }
